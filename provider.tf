...
resource "aws_route_table_association" "week12-sub-a-assoc" {
  subnet_id      = aws_subnet.week12-sub-a.id
  route_table_id = aws_route_table.week12-pub-rt.id
}
...
resource "aws_route_table_association" "week12-sub-b-assoc" {
...
resource "aws_route_table_association" "week12-pri-a-assoc" {
...
resource "aws_route_table_association" "week12-pri-b-assoc" {
  subnet_id      = aws_subnet.week12-pri-b.id
  route_table_id = aws_route_table.week12-pri-rt.id
}

# Internet Gate Way 
resource "aws_internet_gateway" "week12-igw-v2" {
  vpc_id = aws_vpc.week12-vpc.id
...
resource "aws_route_table" "week12-pub-rt" {
  vpc_id = aws_vpc.week12-vpc.id

  route = [{
    cidr_block = "0.0.0.0/0"
    gateway_id = aws_internet_gateway.week12-igw-v2.id
...
# Security Group
resource "aws_security_group" "week12-ssh-sg-v2" {
  name        = "week12_ssh_sg"
...
# Security Group
resource "aws_security_group" "week12-ssh-pri-sg" {
